...
function deleteItem($id) {
    ...
    $.ajax({
        ...
        type: 'Delete',
        success: function(data){
            alert('Item successfully deleted from cart.'); //The message for when the item is deleted from cart
            window.location.href = './cart.html';
        },
        error: function(data){
            alert("Error while deleting item."); //The message if there's an error deleting an item
        }
    })
...
function checkOut() {
    ...
    $.ajax({
        ...
        succes: function(data){
            alert("Checkout is successful!"); //The message is the check out is successful
            windown.location.href = './cart.html';
        },
        error: function(data){
            alert("Error when checking out.") //The message if there's an error checking out
        }
    })
}
