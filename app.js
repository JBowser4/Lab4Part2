...
function setComment($id) {
    ...
    $.ajax({
        ...
        success: function(data){
            alert("Comment has been submitted!"); //The message if the comment is submitted
        },
        error: function(data){
            alert("There's an error posting the comment.") //The message if there's a comment error
        }
...
function addToCart($id) {
    ...
    //TODO complete implementation using the product id
    if (email != ''){
        sessionStorage,setItem('email', email) //Sets the email as email
        ...
        $.ajax({
            ...
            success: function(data){
                alert("Product has been added to cart!"); //The message for when the item has been added to the cart
            },
            error: function(data){
                alert("Error while fetching the data.") //The message for if there's an error adding the item to the cart
            }
        });
    }
    else{
        alert("Please enter your email at the top of the page.") //The message for if the user hasn't submitted their email
    }
